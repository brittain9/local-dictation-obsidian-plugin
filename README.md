...
- **System audio capture** — transcribe meetings, calls, and videos from this computer's output, not just your microphone. Built in on Windows; [virtual-device setup](docs/guides/system-audio.md) covers macOS and Linux.
