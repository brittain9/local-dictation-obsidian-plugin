...
`2e-4`. The real-model suite bounds the runtime token sequence to four edits
from the NeMo oracle, covering legitimate quantized/backend variation without
allowing unbounded token drift.
