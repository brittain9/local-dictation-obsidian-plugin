...
const features =
  process.platform === 'darwin'
    ? 'engine-whisper,engine-cohere-transcribe,engine-moonshine,engine-nemotron-asr,gpu-metal'
    : 'engine-whisper,engine-cohere-transcribe,engine-moonshine,engine-nemotron-asr';
