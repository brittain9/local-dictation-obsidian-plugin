export const en = {
  ...
  'ribbon.queueCatchingUp': '{state} — processing is catching up',
  'ribbon.queueFallingBehind': '{state} — processing is falling behind; pause briefly',
  'ribbon.queueSaturated': '{state} — processing backlog is full; pause speaking',
  'ribbon.stopToChangeLanguage': 'Stop dictation to change language',
  'ribbon.languageSaveFailed': 'Could not change the dictation language.',
  'ribbon.languageMenuHint': '{state}. Right-click to choose language.',
