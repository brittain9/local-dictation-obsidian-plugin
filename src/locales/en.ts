export const en = {
  ...
  'llm.model.summary.routingThreshold': 'Large provider above {value} chars',
  ...
  'llm.failure.permissionDenied': '{provider} denied access. Check account or model access.',
  ...
  'llm.status.permissionDenied': '{provider} denied access.',
  ...
  'llm.provider.custom': 'Custom endpoint',
  'llm.provider.customHost': 'Custom endpoint ({host})',
  ...
  'llm.routing.summary.fixed': 'All transcripts use {provider}',
  'llm.routing.summary.size':
    '{defaultProvider} up to {threshold} characters; {largeProvider} above {threshold}',
  ...
  'llm.routing.customModel.description':
    "Type a model ID. If discovery isn't available, manual entry still works.",
