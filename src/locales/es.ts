...
export const es = {
  ...
  'notice.translationTooLong': 'Traduce hasta {count} caracteres a la vez.',
  ...
  'translation.modal.title': 'Traducir localmente',
  ...
  'translation.modal.stale': 'La nota cambió. Copia o inserta la traducción en su lugar.',
