...
export const es = {
  ...
  'notice.sidecarRestartRequiresIdle': 'Reinicie el sidecar sólo cuando el dictado esté inactivo.',
  ...
  'settings.dictationLanguage.englishOnlyDesc': 'El modelo seleccionado solo admite inglés.',
