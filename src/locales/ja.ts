...
export const ja = {
  ...
  'settings.noteContext.desc':
    '開いているメモから特徴的な用語を送信して、スペルを確認しやすくします。',
  'settings.noteContext.tooltip':
    '固有名詞と専門用語の用語集をエンジンの最初のプロンプトとして送信します。初期プロンプトをサポートするエンジンによってのみ使用されます。',
  ...
  'commands.readEntireNote': 'ノート全体を読み上げ',
  'commands.pauseResumeReadAloud': '読み上げを一時停止または再開',
  'commands.stopReadAloud': '読み上げを停止',
  'settings.groups.readAloud': '読み上げ',
  'settings.readAloud.noModel': '読み上げモデルが選択されていません',
  'settings.readAloud.modelDesc': 'ノートのテキストを読み上げるローカルモデルです。',
  ...
  'models.manage.dictationModels': '音声入力モデル',
  'models.manage.readAloudModels': '読み上げモデル',
