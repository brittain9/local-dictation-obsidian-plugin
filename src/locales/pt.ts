...
export const pt = {
  ...
  'settings.noteContext.desc':
    'Enviar termos específicos da nota aberta para ajudar na ortografia.',
  'settings.noteContext.tooltip':
    'Envia um glossário de nomes próprios e termos técnicos como instrução inicial do motor. Utilizado apenas por motores que suportam instruções iniciais.',
  ...
  'commands.readEntireNote': 'Ler a nota inteira',
  ...
  'settings.readAloud.noModel': 'Nenhum modelo de leitura selecionado',
  'settings.readAloud.modelDesc': 'O modelo local usado para ler o texto das notas.',
  ...
  'catalog.family.pocket_tts.summary':
    'Lê localmente texto de notas em inglês com prosódia natural, vozes selecionáveis e controlo de velocidade que preserva o tom.',
