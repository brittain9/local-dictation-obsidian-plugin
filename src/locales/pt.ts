...
export const pt = {
  ...
  'notice.sidecarRestartRequiresIdle': 'Reinicie o sidecar apenas quando o ditado estiver inativo.',
  ...
  'settings.dictationLanguage.englishOnlyDesc': 'O modelo selecionado apenas suporta inglês.',
